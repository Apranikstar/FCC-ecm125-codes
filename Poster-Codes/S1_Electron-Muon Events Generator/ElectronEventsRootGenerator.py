...
def PreSelectionCutEventsList(RootFile):
    n_elec = np.array(RootFile["events"]["n_electrons"].array())
...
def electrons4Vec(RootFile, IndexList):
    ...
    electron_pT = RootFile["events"]["electrons_pT"].array()
    electron_eta = RootFile["events"]["electrons_eta"].array()
    electron_phi = RootFile["events"]["electrons_phi"].array()
    electron_energy = RootFile["events"]["electrons_energy"].array()
...
# Adjust layout
plt.tight_layout()
plt.savefig("Electrons_Reconstructed_Mass.png")
# Show the plot
...
with uproot.recreate(myFileName+"_Electrons") as file:
    file["events"] = {"Delta_rapidity_JNLO_JLO": Delta_rapidity_JNLO_JLO_HL,
                      "Delta_rapidity_electron_JNLO" : Delta_rapidity_electron_JNLO_HL,
                      "Delta_rapidity_electron_JLO" : Delta_rapidity_electron_JLO_HL,
                      "JetNLO_Rapidity" : JetNLO_Rapidity_HL,
                      "JetLO_Rapidity" : JetLO_Rapidity_HL,
                      "electron_Rapidity" : electron_Rapidity_HL,
                      #"MET_Rapidity" : MET_Rapidity_HL,
                      "Delta_eta_JLO_JNLO" : Delta_eta_JLO_JNLO_HL,
                      "Delta_eta_electron_NJO" : Delta_eta_electron_NJO_HL,
                      "Delta_eta_electron_JLO" : Delta_eta_electron_JLO_HL,
                      "JetNLO_eta" : JetNLO_eta_HL,
                      "JetLO_eta" : JetLO_eta_HL,
                      "electron_eta" : electron_eta_HL,
                      #"MET_eta" : MET_eta_HL,
                      "PT_electron" : PT_e_HL,
                      "PT_JNLO" : PT_JNLO_HL,
                      "PT_JLO" : PT_JLO_HL,
                      "Energy_Transverse_electron" : Energy_Transverse_e_HL,
                      ...
                      "MT_JLO" : MT_JLO_HL,
                      "MT_met" : MT_met_HL,
                      "Phi_electron" : Phi_e_HL,
                      "Phi_JNLO" : Phi_JNLO_HL,
                      "Phi_JLO" : Phi_JLO_HL,
                      "Theta_electron" : Theta_e_HL,
                      "Theta_JNLO" : Theta_JNLO_HL,
                      "Theta_JLO" : Theta_JLO_HL,
                      "cosTheta_electron" : cosTheta_e_HL,
                      "cosTheta_JNLO" : cosTheta_JNLO_HL,
                      "cosTheta_JLO" : cosTheta_JLO_HL,
                      "CosAngle_JNLO_JLO" : CosAngle_JNLO_JLO_HL,
                      "CosAngle_Electron_JNLO" : CosAngle_Electron_JNLO_HL,
                      "CosAngle_Electron_JLO" : CosAngle_Electron_JLO_HL,
                      ...
                      "DeltaPhi_electron_JNLO" : DeltaPhi_electron_JNLO_HL,
                      "DeltaPhi_electron_JLO" : DeltaPhi_electron_JLO_HL,
                      "DeltaR_JNLO_JLO" : DeltaR_JNLO_JLO_HL,
                      "DeltaR_electron_JLO" : DeltaR_electron_JLO_HL,
                      "DeltaR_electron_JNLO" :DeltaR_electron_JNLO_HL
                     }
    file.close()
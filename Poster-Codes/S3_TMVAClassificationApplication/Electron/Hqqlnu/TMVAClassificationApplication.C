...
void TMVAClassificationApplication( TString myMethodList = "" )
{
   ...
   //
   TFile *input(0);
   TString fname = "Electron_DataBase/Electron_wzp6_ee_l1l2nunu_ecm125.root";
   ...
   theTree->SetBranchAddress("Delta_rapidity_electron_JNLO", &user_Delta_rapidity_electron_JNLO);
   theTree->SetBranchAddress("Delta_rapidity_electron_JLO", &user_Delta_rapidity_electron_JLO);
   theTree->SetBranchAddress("JetNLO_Rapidity", &user_JetNLO_Rapidity);
   theTree->SetBranchAddress("JetLO_Rapidity", &user_JetLO_Rapidity);
   theTree->SetBranchAddress("electron_Rapidity", &user_electron_Rapidity);
   theTree->SetBranchAddress("Delta_eta_JLO_JNLO", &user_Delta_eta_JLO_JNLO);
   theTree->SetBranchAddress("Delta_eta_electron_NJO", &user_Delta_eta_electron_NJO);
   theTree->SetBranchAddress("Delta_eta_electron_JLO", &user_Delta_eta_electron_JLO);
   theTree->SetBranchAddress("JetNLO_eta", &user_JetNLO_eta);
   theTree->SetBranchAddress("JetLO_eta", &user_JetLO_eta);
   theTree->SetBranchAddress("electron_eta", &user_electron_eta);
   theTree->SetBranchAddress("PT_electron", &user_PT_electron);
   theTree->SetBranchAddress("PT_JNLO", &user_PT_JNLO);
   theTree->SetBranchAddress("PT_JLO", &user_PT_JLO);
   theTree->SetBranchAddress("Energy_Transverse_electron", &user_Energy_Transverse_electron);
   ...
   theTree->SetBranchAddress("Energy_electron", &user_Energy_electron);
   ...
   theTree->SetBranchAddress("M_electron", &user_M_electron);
   theTree->SetBranchAddress("M_met", &user_M_met);
   theTree->SetBranchAddress("MT_electron", &user_MT_electron);
   ...
   theTree->SetBranchAddress("CosAngle_Electron_JNLO", &user_CosAngle_Electron_JNLO);
   theTree->SetBranchAddress("CosAngle_Electron_JLO", &user_CosAngle_Electron_JLO);
   ...
   theTree->SetBranchAddress("DeltaPhi_electron_JNLO", &user_DeltaPhi_electron_JNLO);
   theTree->SetBranchAddress("DeltaPhi_electron_JLO", &user_DeltaPhi_electron_JLO);
   theTree->SetBranchAddress("DeltaR_JNLO_JLO", &user_DeltaR_JNLO_JLO);
   theTree->SetBranchAddress("DeltaR_electron_JLO", &user_DeltaR_electron_JLO);
   theTree->SetBranchAddress("DeltaR_electron_JNLO", &user_DeltaR_electron_JNLO);

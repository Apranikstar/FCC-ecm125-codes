...
# Ask user for binning and luminosity
n_bins = int(input("Enter number of BDT bins (e.g., 10): "))
luminosity = float(input("Enter luminosity (in 1/fb): "))
...
for process, group in df.groupby("process"):
    ...
    # Compute efficiency and final cross section
...
# ------------------ SAVE ------------------
output_pkl = "bdt_distributions/bdt_binned_with_cross_sections.pkl"
